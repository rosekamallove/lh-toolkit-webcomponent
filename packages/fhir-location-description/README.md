...
The fhir-location-description adds description of location to the page. It is commonly used 
 ...
 * It can also receive value from a 'url' which can be passed as property "url". The `description` key value is checked for  in key-value pair of data.
...
### Properties of fhir-location-description
 * `value`:`String` - used to take the input value of each field.
 * `url`:`String` - used to make AJAX call to FHIR resource. Default: null.
 * `describeField`:`String` - is to show description of location . Use this property to show/hide. Default: true.
 ### License
 Mozilla Public License, v. 2.0.
 
 ### Typical Use:
 * With url:
 `<fhir-location-description url=""></fhir-location-description>`
 * Without url:
  `<fhir-location-description></fhir-location-description>`
